...
public class UserController {
    ...
    public AjaxResult phoneRegister(@RequestBody RegisterDTO registerDTO){
        try {
    ...
    public AjaxResult sendRegisterMessageCode(@RequestParam(value = "phone") String phone){
        try {
            userService.sendRegisterMessageCode(phone);
            return AjaxResult.me();
        } catch (Exception e) {
            e.printStackTrace();
